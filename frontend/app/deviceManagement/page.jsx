            ...
            {devices.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500">
                  Devices will appear here once you access your account from
                  different devices
                </p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      {currentDevice?.id !== device.id && (
                        ...
                        >
                          <Trash2
                            className={`h-5 w-5 ${deletingId === device.id ? "animate-spin" : ""}`}
                          />
                        </button>
                      )}
                    </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 mb-4">
                    You've reached the maximum number of devices allowed with
                    your current plan. To use additional devices, you'll need to
                    purchase more device slots or remove an existing device.
                  </p>
                  <button
                    onClick={() => onNavigate("add-devices")}
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <ul className="space-y-3 text-slate-700">
            <li className="flex items-start space-x-3">
              ...
              <span>
                Each subscription plan includes a limited number of concurrent
                devices
              </span>
            </li>
            <li className="flex items-start space-x-3">
              <span className="text-emerald-600 font-bold">•</span>
              <span>
                A device is identified by your browser and device fingerprint,
